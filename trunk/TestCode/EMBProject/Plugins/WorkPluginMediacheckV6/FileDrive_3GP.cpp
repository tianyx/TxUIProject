// FileDrive_3GP.cpp: implementation of the CFileDrive_3GP class.
//
//////////////////////////////////////////////////////////////////////

#include "stdafx.h"
//#include "FCVSServer.h"
#include "FileDrive_3GP.h"
...
//////////////////////////////////////////////////////////////////////
REGISTER_CLASS(CFileDriver_3GP)
CFileDriver_3GP::CFileDriver_3GP() : CFileDriver(&m_DriverMgr_3GP)
{
	m_strTskID = "";
	m_strCheckKind = "";
	m_strFileType = "";
...
//	m_DriverMgr_3GP.SetCallBack((JS_CCallBack*)this);
//	m_DriverMgr_3GP.SetBuffer((void*)&m_SampleList);
//	m_DriverMgr_3GP.SetParent(m_hWnd);
}

CFileDriver_3GP::~CFileDriver_3GP()
{
	OutputDebugString("into CFileDriver_3GP::~CFileDriver_3GP()\n");
}

void CFileDriver_3GP::ShowMsg()
{
	AfxMessageBox(m_strMsg);
}
bool CFileDriver_3GP::InitDetectParam()
{
...
BOOL CFileDriver_3GP::InitTask(CString strXML)
{
	if (strXML.IsEmpty())
	{
		return FALSE;
...
// 	XmlOpReader.GetAttribute("ClipType",m_strClipType,strErr,"TaskData");
// 	CString strClipTypePara = (LPCSTR)GetFCVSServerConfig().GetDetectParaXml(m_strClipType);
//     CString strDriverPara   = GetFCVSServerConfig().GetXmlByClassName("CFileDriver_3GP");
// 	CXMLOp XmlClipTypePara;
// 	CXMLOp XmlDrivePara;
...
// 	m_DriverMgr_3GP.SetBuffer((void*)&m_SampleList);
// 	if(GetFCVSServerConfig().m_bCheckAudio)
// 	   m_DriverMgr_3GP.SetAudioBuffer((void*)&m_AudioSampleList);
// 	m_DriverMgr_3GP.SetParent(m_hWnd);
// 	///add end
...
BOOL CFileDriver_3GP::RunTask()
{
	BOOL bRet = m_DriverMgr_3GP.Run();
	if (bRet)
	{
...
BOOL CFileDriver_3GP::PauseTask()
{
	BOOL bRet = m_DriverMgr_3GP.Pause();
	if (bRet)
	{
...
BOOL CFileDriver_3GP::CancelTask()
{
	return m_DriverMgr_3GP.Cancel();
}

CString CFileDriver_3GP::GetTskID()
{
	return m_strTskID;
}

void CFileDriver_3GP::SetParentWnd(HWND hwnd)
{
	m_hParentWnd = hwnd;
}

HRESULT CFileDriver_3GP::GetFileInfo(JS_StreamInfo p)
{
	m_StreamInfo = p;
...
LONGLONG CFileDriver_3GP::GetFileDuration()
{
	return m_StreamInfo.llFileDuration;
}

BOOL CFileDriver_3GP::GetFileInfoByArr(CStringArray& strFileInfoFiledArr,CStringArray& strFileInfoValueArr,BOOL bXML /* = TRUE */)
{
	CString strTemp;
	if (bXML)
	{
...
void CFileDriver_3GP::Submit()
{
	...
	m_DriverMgr_3GP.OpenFile(m_str);
	m_DriverMgr_3GP.StartInfoCheckThread();
	...
	m_DriverMgr_3GP.StartDecodeThread();
...
void CFileDriver_3GP::SetServiceName(CString strServiceNameOp)
{
	m_strServiceNameOp = strServiceNameOp;
}

UINT CFileDriver_3GP::TskCheckThread(LPVOID pParam)
{
	MyMediaSample* pMediaSample = NULL;
	CFileDriver_3GP* pParent = (CFileDriver_3GP*)pParam;
...
UINT CFileDriver_3GP::TskAudioCheckThread(LPVOID pParam)
{
	MyMediaSample* pMediaSample = NULL;
	CFileDriver_3GP* pParent = (CFileDriver_3GP*)pParam;
