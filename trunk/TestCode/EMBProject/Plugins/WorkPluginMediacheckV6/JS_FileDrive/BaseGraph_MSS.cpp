// BaseGraph_PNCL.cpp: implementation of the CBaseGraph_PNCL class.
//
//////////////////////////////////////////////////////////////////////
...
HRESULT CBaseGraph_MSS::AddFilters2Graph()
{
...
//	hr = AddFilter2GraphByFriendlyName(m_pGraphBuilder,"MainConcept MPEG-2 Video Decoder",&m_pVDecoder);
	...
	//hr = AddFilter2GraphByFriendlyName(m_pGraphBuilder,"Founder Mpeg Splitter",&m_pParserFilter);
	if (hr != S_OK)
	{
		return hr;
	}
...
HRESULT CBaseGraph_MSS::ConnectFiltersInGraph()
{
	HRESULT hr = E_FAIL;
...
HRESULT CBaseGraph_MSS::BuildGrabberGraph()
{
