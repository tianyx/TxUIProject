// FileDrive_MP4.cpp: implementation of the CFileDrive_MP4 class.
//
//////////////////////////////////////////////////////////////////////

#include "stdafx.h"
//#include "FCVSServer.h"
#include "FileDrive_MP4.h"
...
//////////////////////////////////////////////////////////////////////
REGISTER_CLASS(CFileDriver_MP4)
CFileDriver_MP4::CFileDriver_MP4() : CFileDriver(&m_DriverMgr_MP4)
{
	m_strTskID = "";
	m_strCheckKind = "";
	m_strFileType = "";
...
//	m_DriverMgr_MP4.SetCallBack((JS_CCallBack*)this);
//	m_DriverMgr_MP4.SetBuffer((void*)&m_SampleList);
//	m_DriverMgr_MP4.SetParent(m_hWnd);
}

CFileDriver_MP4::~CFileDriver_MP4()
{
	OutputDebugString("into CFileDriver_MP4::~CFileDriver_MP4()\n");
}


void CFileDriver_MP4::ShowMsg()
{
	AfxMessageBox(m_strMsg);
}
bool CFileDriver_MP4::InitDetectParam()
{
...
BOOL CFileDriver_MP4::InitTask(CString strXML)
{
	if (strXML.IsEmpty())
	{
		return FALSE;
...
// 	XmlOpReader.GetAttribute("ClipType",m_strClipType,strErr,"TaskData");
// 	CString strClipTypePara = (LPCSTR)GetFCVSServerConfig().GetDetectParaXml(m_strClipType);
//     CString strDriverPara   = GetFCVSServerConfig().GetXmlByClassName("CFileDriver_MP4");
// 	CXMLOp XmlClipTypePara;
// 	CXMLOp XmlDrivePara;
...
// 	m_DriverMgr_MP4.SetBuffer((void*)&m_SampleList);
// 	if(GetFCVSServerConfig().m_bCheckAudio)
// 	   m_DriverMgr_MP4.SetAudioBuffer((void*)&m_AudioSampleList);
// 	m_DriverMgr_MP4.SetParent(m_hWnd);
// 	///add end
...
BOOL CFileDriver_MP4::RunTask()
{
	BOOL bRet = m_DriverMgr_MP4.Run();
	if (bRet)
	{
...
BOOL CFileDriver_MP4::PauseTask()
{
	BOOL bRet = m_DriverMgr_MP4.Pause();
	if (bRet)
	{
...
BOOL CFileDriver_MP4::CancelTask()
{
	return m_DriverMgr_MP4.Cancel();
}

CString CFileDriver_MP4::GetTskID()
{
	return m_strTskID;
}

void CFileDriver_MP4::SetParentWnd(HWND hwnd)
{
	m_hParentWnd = hwnd;
}

HRESULT CFileDriver_MP4::GetFileInfo(JS_StreamInfo p)
{
	m_StreamInfo = p;
...
LONGLONG CFileDriver_MP4::GetFileDuration()
{
	return m_StreamInfo.llFileDuration;
}

BOOL CFileDriver_MP4::GetFileInfoByArr(CStringArray& strFileInfoFiledArr,CStringArray& strFileInfoValueArr,BOOL bXML /* = TRUE */)
{
	CString strTemp;
	if (bXML)
	{
...
void CFileDriver_MP4::Submit()
{
	...
	m_DriverMgr_MP4.OpenFile(m_str);
	m_DriverMgr_MP4.StartInfoCheckThread();
...
//	m_pAutoDetect->SetAudioType(2,48000,16,4);
	m_DriverMgr_MP4.StartDecodeThread();
...
void CFileDriver_MP4::SetServiceName(CString strServiceNameOp)
{
	m_strServiceNameOp = strServiceNameOp;
}

UINT CFileDriver_MP4::TskCheckThread(LPVOID pParam)
{
	MyMediaSample* pMediaSample = NULL;
	CFileDriver_MP4* pParent = (CFileDriver_MP4*)pParam;
	...
	//while (TRUE)
	{
		...
		while (WaitForSingleObject(pParent->m_ThreadEvent,INFINITE) == WAIT_OBJECT_0)
		{
			...
			OutputDebugString("正在检测视频...");
		}
	}
	OutputDebugString("视频检测结束!");
...
UINT CFileDriver_MP4::TskAudioCheckThread(LPVOID pParam)
{
	MyMediaSample* pMediaSample = NULL;
	CFileDriver_MP4* pParent = (CFileDriver_MP4*)pParam;
