// FileDriver_Omn.h: interface for the CFileDriver_Omn class.
//
//////////////////////////////////////////////////////////////////////

#if !defined(AFX_FILEDRIVER_OMN_H__FF2D9A44_BD90_4508_B352_8651F024006D__INCLUDED_)
#define AFX_FILEDRIVER_OMN_H__FF2D9A44_BD90_4508_B352_8651F024006D__INCLUDED_
...
class CFileDriver_Omn : public CFileDriver 
{
public:
	CFileDriver_Omn();
	virtual ~CFileDriver_Omn();
...
public:
	...
	CString m_strMsg;
private:
	CDriveMgr_MXF   m_DriverMgr_MXF;  //技审文件驱动
public:
	static UINT TskCheckThread(LPVOID pParam);
	static UINT TskAudioCheckThread(LPVOID pParam);
};

#endif // !defined(AFX_FILEDRIVER_OMN_H__FF2D9A44_BD90_4508_B352_8651F024006D__INCLUDED_)
