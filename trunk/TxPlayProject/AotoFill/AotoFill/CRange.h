...
// CExcellRange 包装类
#include "predefine.h"
class CExcellRange : public COleDispatchDriver
{
public:
	CExcellRange(){} // 调用 COleDispatchDriver 默认构造函数
	CExcellRange(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CExcellRange(const CExcellRange& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
